...
var file_company_service_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x69, 0x6e, 0x6e, 0x32, 0xc0, 0x02, 0x0a, 0x0e, 0x43, 0x6f,
	0x6d, 0x70, 0x61, 0x6e, 0x79, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x38, 0x0a, 0x06,
	0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x12, 0x11, 0x2e, 0x67, 0x65, 0x6e, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x2e, 0x43, 0x6f, 0x6d, 0x70, 0x61, 0x6e, 0x79, 0x1a, 0x19, 0x2e, 0x67, 0x65, 0x6e, 0x70,
	...
	,
...
var file_company_service_proto_goTypes = []interface{}{
	...
	(*GetAllCompanyResponse)(nil), // 5: genproto.GetAllCompanyResponse
...
var file_company_service_proto_depIdxs = []int32{
	...
	2, // 2: genproto.CompanyService.Get:input_type -> genproto.GetRequest
	0, // 3: genproto.CompanyService.GetAll:input_type -> genproto.GetAllCompanyRequest
	3, // 4: genproto.CompanyService.Delete:input_type -> genproto.DeleteRequest
	4, // 5: genproto.CompanyService.Create:output_type -> genproto.CreatedResponse
	4, // 6: genproto.CompanyService.Update:output_type -> genproto.CreatedResponse
	1, // 7: genproto.CompanyService.Get:output_type -> genproto.Company
	5, // 8: genproto.CompanyService.GetAll:output_type -> genproto.GetAllCompanyResponse
	6, // 9: genproto.CompanyService.Delete:output_type -> google.protobuf.Empty
...
type CompanyServiceClient interface {
	Create(ctx context.Context, in *Company, opts ...grpc.CallOption) (*CreatedResponse, error)
	Update(ctx context.Context, in *Company, opts ...grpc.CallOption) (*CreatedResponse, error)
	Get(ctx context.Context, in *GetRequest, opts ...grpc.CallOption) (*Company, error)
...
func (c *companyServiceClient) Create(ctx context.Context, in *Company, opts ...grpc.CallOption) (*CreatedResponse, error) {
...
func (c *companyServiceClient) Update(ctx context.Context, in *Company, opts ...grpc.CallOption) (*CreatedResponse, error) {
	out := new(CreatedResponse)
...
func (c *companyServiceClient) Get(ctx context.Context, in *GetRequest, opts ...grpc.CallOption) (*Company, error) {
	out := new(Company)
...
func (c *companyServiceClient) Delete(ctx context.Context, in *DeleteRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
type CompanyServiceServer interface {
	Create(context.Context, *Company) (*CreatedResponse, error)
	Update(context.Context, *Company) (*CreatedResponse, error)
	Get(context.Context, *GetRequest) (*Company, error)
...
func (*UnimplementedCompanyServiceServer) Create(context.Context, *Company) (*CreatedResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Create not implemented")
}
func (*UnimplementedCompanyServiceServer) Update(context.Context, *Company) (*CreatedResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Update not implemented")
}
func (*UnimplementedCompanyServiceServer) Get(context.Context, *GetRequest) (*Company, error) {
...
func (*UnimplementedCompanyServiceServer) Delete(context.Context, *DeleteRequest) (*emptypb.Empty, error) {
